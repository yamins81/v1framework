...
('filter', SON([
    ...
    ('specs',[SON([
      ('width',64),
      ('height',64),
      ('objects',[SON([('sx',.5),('sy',2),('object',cairo_objects.SQUARE),('pattern',cairo_objects.SOLID_RED)]),
                  SON([('tx',.102),('sx',.5),('sy',2),('object',cairo_objects.SQUARE),('pattern',cairo_objects.SOLID_BLUE)])])
      ]),SON([
      ('width',64),
      ('height',64),
      ('objects',[SON([('sx',2),('sy',.5),('object',cairo_objects.SQUARE),('pattern',cairo_objects.SOLID_RED)]),
                  SON([('ty',.102),('sx',2),('sy',.5),('object',cairo_objects.SQUARE),('pattern',cairo_objects.SOLID_BLUE)])])
            ])
      ])
    ])),
