...
model = SON([(u'color_space', u'gray'), 
             ...
             (u'layers', [SON([(u'lnorm', SON([(u'inker_shape', [9, 9]), (u'outker_shape', [9, 9]), (u'threshold', 1.0), (u'stretch', 1)]))]),
                          SON([(u'filter', SON([(u'model_name', u'really_random'), (u'num_filters', 16), (u'ker_shape', [7, 7])])), 
                          ...
                          SON([(u'filter', SON([(u'model_name', u'really_random'), (u'num_filters', 128), (u'ker_shape', [5, 5])])), 
                               (u'activ', SON([(u'min_out', 0), (u'max_out', 1)]))])])
        ])
