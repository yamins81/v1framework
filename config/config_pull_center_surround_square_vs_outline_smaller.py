...
('filter', SON([
    ...
    ('base_images',[SON([('generator', 'cairo'),
                     ('height', 64),
                     ('width',64),
                     ('object', [SON([('args',[.05]),('type','set_line_width')]),SON([('args', [-0.1, -0.1, 0.2, 0.2]), ('type', 'rectangle')])]),
...
'image' : SON([
      ...
      ('width' , 64),
      ('height' , 64),
      ('objects' , [[SON([('args',[.05]),('type','set_line_width')]),SON([('args', [-0.1, -0.1, 0.2, 0.2]), ('type', 'rectangle')])]]),
