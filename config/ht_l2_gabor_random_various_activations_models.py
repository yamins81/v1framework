...
param_set = [(0,'lnorm',['inker_shape','outker_shape'],[[3,3],[7,7]]),
             (1,'filter','ker_shape',[[7,7]]),
             (1,'activ','min_out',[-.5,-.3,-.1,.1,.3]),
             (1,'lpool','ker_shape',[[3,3],[9,9]]),
             (2,'filter','ker_shape',[[3,3],[9,9]]),
             (2,'activ','min_out',[-.5,-.3,-.1,.1,.3])]
