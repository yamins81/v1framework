...
config = {
     ...
     'train_test' : [    
		   ...
		   SON([
			  ...
			  ('ntrain_pos',64),
			  ('ntest_pos',16),
			  ('universe',SON([('image.rxy',SON([('$lt',.05)]))])),
			  ('query',SON([('image.object.type','rectangle')]))
			  ]),	
		   SON([
		      ('transform_average', SON([('transform_name','translation')])),
			  ...
			  ('ntrain_pos',64),
			  ('ntest_pos',16),
			  ('universe',SON([('image.rxy',SON([('$lt',.05+.75),('$gt',.75)]))])),
			  ('query',SON([('image.object.type','rectangle')]))
			  ]),	
		   SON([
		      ('transform_average', SON([('transform_name','translation')])),
			  ...
			  ('ntrain_pos',64),
			  ('ntest_pos',16),
			  ('universe',SON([('image.actions','fill')])),
			  ('query',SON([('image.object.type','rectangle')]))
			  ]),	
		   SON([
		      ('transform_average', SON([('transform_name','translation')])),
			  ...
			  ('ntrain_pos',64),
			  ('ntest_pos',16),
			  ('universe',SON([('image.actions','fill'),('image.pattern.color_stops',SON([('$exists',False)]))])),
			  ('query',SON([('image.object.type','rectangle')]))
			  ]),				  
		   SON([
		      ('transform_average', SON([('transform_name','translation')])),
			  ...
			  ('ntrain_pos',64),
			  ('ntest_pos',16),
			  ('universe',SON([('image.actions','fill'),('image.pattern.color_stops',SON([('$exists',False)])),('image.pattern.args',[1,0,0,1.0])])),
			  ('query',SON([('image.object.type','rectangle')]))
			  ]),
		   SON([
		      ('transform_average', SON([('transform_name','translation')])),
			  ...
			  ('ntest_pos',16),
			  ('universe',SON([('image.actions','fill'),
			                   ('image.pattern.color_stops',SON([('$exists',False)])),
			                   ('image.pattern.args',[1,0,0,1.0]),
			                   ('image.object.type',SON([('$in',['arc','rectangle'])]))
			                   ])),
			  ('query',SON([('image.object.type','rectangle')]))
			  ]),
		   SON([
