...
model1['layers'][1]['filter']['numfilters'] = 32
model1['layers'][2]['filter']['num_filters'] = 128
...
model2['layers'][1]['filter']['num_filters'] = 128
model2['layers'][2]['filter']['num_filters'] = 512

model2a = copy.deepcopy(base_model)
model2a['layers'][1]['filter']['ker_shape'] = [21,21]
model2a['layers'][1]['filter']['num_filters'] = 120
model2a['layers'][2]['filter']['num_filters'] = 360

model2b = copy.deepcopy(base_model)
model2b['layers'][1]['filter']['ker_shape'] = [43,43]
model2b['layers'][1]['filter']['num_filters'] = 120
model2b['layers'][2]['filter']['num_filters'] = 360

model2c = copy.deepcopy(base_model)
model2c['layers'][1]['filter']['ker_shape'] = [21,21]
model2c['layers'][1]['filter']['num_filters'] = 144
model2c['layers'][2]['filter']['num_filters'] = 864
