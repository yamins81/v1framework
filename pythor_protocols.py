...
def evaluate_core(split,m,task,extraction,extraction_hash,use_db):
    ...
    return train_test(task,train_filenames,test_filenames,train_labels,test_labels,train_features,test_features,classifier_kwargs)
...
def generate_splits(task_config,hash,colname,overlap=None,reachin=True,balance=None):
    ...
    if isinstance(query,list):
        ...
        splits = traintest.generate_split2(DB_NAME,colname,cquery,N,ntrain,ntest,
